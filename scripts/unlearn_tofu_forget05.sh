...
model_path=/tofu/data/ft_epoch5_lr1e-05_llama2-7b_full_wd0.01/checkpoint-625 

method_name=DRAGON
save_file_name=evaluation_results/tofu/${split}_${model_family}_${method_name}_${evaluation_method}.csv
path_to_aggregated_retain_result=data/eval/tofu_sides/ft_epoch5_lr1e-05_llama2-7b_retain90_wd0.01/checkpoint-562/eval_results/ds_size300/eval_log_aggregated.json
